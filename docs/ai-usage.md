...
As of 8/30/2026 - I have decided not to utilize AI tools to aid in the building and documentation of my project so that I can learn to build something on my own and use that experience to better utilize AI tools for future projects with a better understanding of what I need those AI tools to do. 
...
2026-08-30 - No AI used to complete artifacts of Milestone 1
